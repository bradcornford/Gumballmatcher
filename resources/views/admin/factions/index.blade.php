...
@section ('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($factions) > 0 ? 'datatable' : '' }} @can ('admin-faction-mass-delete') dt-select @endcan">
                <thead>
                    <tr>
                        @can ('admin-faction-mass-delete')
                ...
                <tbody>
                    @forelse ($factions as $faction)
                        <tr data-entry-id="{{ $faction->id }}">
                            @can ('admin-faction-delete', $faction)
                                <td class=""></td>
                            @endcan
