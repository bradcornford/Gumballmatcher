                ...
                <div class="col-md-12">
                    ...
                    <div class="btn-group btn-group-justified" role="group">
                        <div class="btn-group" role="group">
                            <a class="btn btn-default btn-lg overflow-hidden" href="{{ route('admin.roles.index') }}" title="@lang ('admin.roles.title')"><span class="glyphicon glyphicon-tasks"></span> <span class="hidden-xs">@lang ('admin.roles.title')</span></a>
                        </div>
                        <div class="btn-group" role="group">
